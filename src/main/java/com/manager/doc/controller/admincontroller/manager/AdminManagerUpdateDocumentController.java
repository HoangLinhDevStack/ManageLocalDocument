...
@Controller
@RequestMapping("admin/manager/update-document")
public class AdminManagerUpdateDocumentController {
...
//            // form.getGenreIdsStr() có thể là null hoặc chuỗi rỗng
            ...
            if (!hasChanges) {
                ...
                return "redirect:/ManagerBook/admin/manager/update-document/" + documentId;
            }
