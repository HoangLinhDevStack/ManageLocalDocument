...
@Controller
@RequestMapping("admin/manager/list-document")
public class AdminManagerListDocumentController {
    ...
    public String restoreDocument(@PathVariable("id") int documentId, RedirectAttributes redirectAttributes) {
        ...
        return "redirect:/ManagerBook/admin/manager/list-document/deleted";
    }
