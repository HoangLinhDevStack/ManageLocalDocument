...
@Controller
@RequestMapping("admin/manager/up-document")
@PropertySource("classpath:application.properties")
public class AdminManagerUpDocumentController {
    ...
    public String uploadDocument(@RequestParam("title") String title,
        ...
        if (title == null || title.trim().isEmpty()) {
            ...
            return "redirect:/ManagerBook/admin/manager/up-document";
        }
...
//        }
        ...
        try {
            ...
            return "redirect:/ManagerBook/admin/manager/list-document";

        } catch (IllegalArgumentException e) {
            redirectAttributes.addFlashAttribute("uploadError", "Trạng thái không hợp lệ");
            return "redirect:/ManagerBook/admin/manager/upload-document";
        } catch (Exception e) {
