    ...
    <div class="d-flex height-100percent">
        ...
        <div id="right-side" class="padding-0 container">
            ...
            <div class="container">
                ...
                <h3 class="text-center mt-3">Cập nhập thông tin của bạn</h3>
                ...
                <sec:authorize access="hasAuthority('Manager')">
                    ...
                    <form:form action="${pageContext.request.contextPath}/ManagerBook/admin/manager/update-account/update-admin-yourself" method="post" id="userForm">
