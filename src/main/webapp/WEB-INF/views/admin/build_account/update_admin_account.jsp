    ...
    <div class="d-flex height-100percent">
        ...
        <div id="right-side" class="padding-0 container">
            ...
            <div class="container">
                ...
                <form:form action="${pageContext.request.contextPath}/ManagerBook/admin/super/update-account/update-admin" method="post" id="userForm">

                    <!-- User ID is critical for the update operation -->
                    <input type="hidden" name="id" value="${admin.id}">
                    <!-- Add a visible debug field for the ID -->
                    <div class="alert alert-info mb-3">
                        Admin ID: ${admin.id} (This ID will be used for the update operation)
                    </div>
